...
**(2)** これはライセンス自体に関するルールです。 Sam Hocevar がこのライセンスを作成しました。あなたはライセンスを改変することも可能ですが、改変したものをWTFPLと呼ぶことはできない、と書いてあります。

**(3)** これは著作物に関するルールです。 単に **DO WHAT THE FUCK YOUT WANT TO** (お前の好きにせえよクソが) とだけ書いてあります。
